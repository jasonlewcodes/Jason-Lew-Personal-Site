...
const Projects = () => {
  return (
    <Container id="projects">
      ...
      <a className="subtitle inline-flex pb-2 md:pb-0" href="https://github.com/jasonlewcodes/Cervical-Cancer-Classification">
        Cervical Cancer Classification
        <FaExternalLinkAlt className="ml-1 mt-2" size={12}/>
      </a>
      <div className="text-sm">
        <div className="inline md:inline-flex pb-2">
          <img className="h-28 xl:h-48 pr-0 md:pr-2 pb-2 md:pb-0 mx-auto" src={CCModelImage1}/>
        ...
        , I classify cervical cancer diagnoses using dataset of 30+ risk factors and 
        800+ data points using Numpy, Pandas, Seaborn, Pyplot, and Imblearn in Python. 
        I implement a Logistic Regression model using SKLearn with 99%+ accuracy and visualize 
        model statistics.
      </div>
      <br/>
      <a className="subtitle inline-flex" href="https://jasonlewcodes.github.io/Jason-Lew-Personal-Site/">
      ...
      <div className="text-sm">
        ...
        <br/>
        <br/>
        I develop this site using JavaScript 
        &#38; TypeScript, HTML, CSS &#38; TailwindCSS, React, and Gatsby hosted 
      ...
      <div className="text-sm">
        ...
        <br/>
        <br/>
        At PerfectRec, my tech stack includes: JavaScript &#38; TypeScript, HTML, 
        CSS &#38; TailwindCSS, React, NextJS, and PostgresSQL.
      </div>
      <br/>
      <a className="subtitle inline-flex" href="https://arxiv.org/abs/2210.00389v2">
      ...
      <div className="text-sm">
        ...
        for each horizontal edge. I produced statistics in Python to the scale of
        2<sup>20</sup> vertices. This paper was submitted to arXiv.
      </div>
    </Container>
  )
}
